...
\setlength{\tabcolsep}{1pt} %reduces horizontal padding in table. 
\begin{table}
\centering
\begin{tabular}{|c|c|}
\hline
...
\hline
\raisebox{-.5\height}{\includegraphics[width=\Lwidth]{images/overhead_starting.jpg}} & \pbox{\Rwidth}{Explore environment to find all pink or green objects and blue dropoff zone. Deliver all objects to dropoff zone.}\\ 
\hline
\raisebox{-.5\height}{\includegraphics[width=\Lwidth]{images/stairs_explore_overhead.jpg}} & \pbox{\Rwidth}{Explore environment to find mailbox, then deliver a circuit to the box.} \\ 
\hline
\raisebox{-.5\height}{\includegraphics[width=\Lwidth]{images/stamp_explore_overhead.jpg}} & \pbox{\Rwidth}{Explore environment to find package, then place a stamp on the package.} \\ 
\hline
\end{tabular}
