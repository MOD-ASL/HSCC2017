...
\begin{figure}
\begin{center}
\includegraphics[width=0.25\textwidth]{images/sensor_module2.jpg}
...
In the next state, the specified high level behavior properties are mapped to a behavior from the design library which satisfies both the behavior properties and current environment properties.
