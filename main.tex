...
\title{Perception Informed Controller Synthesis for Exploration Mission in Unknown Environment with Modular Robot System}
...
\keywords{\#Unicorns \#DonkeyWithTrafficCone}

\section{Introduction}
\begin{enumerate}
\item Motivate why a system with sensing, locomotion and actuation for autonomous exploration in unknown environment is important and hard.
\item Show previous work on exploration with robot.
\item Compare with previous work on mission with modular robots (RSS).
\end{enumerate}

\section{System Overview}
\begin{enumerate}
\item System flowchart
\end{enumerate}

\section{High-level Mission Planner}

\section{Locomotion with parametric behaviors}

\section{Exploration in Unknown work space}
