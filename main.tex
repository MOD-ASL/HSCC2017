...
To create robot configurations and behaviors, we utilize a computer simulation program called VSPARC (Verification, Simulation, Programming And Robot Construction \footnote{\url{www.vsparc.org}}) presented in \cite{Jing2016}.
...
\begin{tabular}{ |c|c|c| } 
 ...
 & properties & Types \\
 \hline
 Car & \textbf{pickUp} & ``free'' \\\hline
 Car & \textbf{drop} & ``free'' \\\hline
 Car & \textbf{drive} & ``free''\\ \hline
