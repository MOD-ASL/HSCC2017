...
\abj{In addition, the ``Tank'' configuration can also drive on a flat plain as a
differential drive robot using a parametric ``Drive'' behavior with a given sequence of 2D waypoints.}
