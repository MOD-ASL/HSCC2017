...
Figure \ref{fig:exps}a shows the environment setup for Experiment II, which includes an obstacle (cardboard box), a staircase, and the mailbox at the top of the staircase.  The mailbox is marked with a pink rectangle.  The astute reader will recognize that this scenario is identical to the mail delivery example referred to throughout the paper.  
