...
The perception and exploration subsystem interprets sensor data to allow the robot to map and explore the environment. At a minimum, our architecture requires this subsystem to be capable of SLAM, waypoint selection for exploration, path planning, and some form of object recognition. \TODO{Jonathan, is this correct?}
...
\begin{figure}[t]
      ...
      \begin{subfigure}[t]{0.24\textwidth}
        \includegraphics[width=\textwidth]{images/stairs_explore_overhead_label.jpg}
        %\label{fig:obja}
    ...
    \begin{subfigure}[t]{0.24\textwidth}
        \includegraphics[width=\textwidth]{images/stamp_explore_overhead_label.jpg}
        %\label{fig:objb}
...
Table~\ref{table:data} shows the causes of failure for 24 attempts of Experiment 2 (placing the stamp on the package).  
