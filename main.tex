...
%
This paper presents the first clear example of how a modular robot system should be designed in order to leverage reconfigurability to reactively address tasks in an unknown environment.  This fulfills a long-standing promise, and marks a significant milestone in the field.
