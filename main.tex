...
In our architecture, the high-level planner subsystem provides a framework for users to specify tasks  at a high level using a formal language, and acts as the main, centralized controller that directs robot motion and actions based on the given tasks.\TODO{Jim, expand on / correct this. What aspects of the high level planner are general requirements of our architecture, and what aspects are specific to our implementation?}
