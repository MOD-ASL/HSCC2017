...
\subsection{Balancing Distributed and Centralized Architectures}
...
Mechanically (at the low level), our system maintains the distributed characteristics that make modular systems flexible: the body of the robot is composed of identical modules that reconfigure to form a variety of physical morphologies.
