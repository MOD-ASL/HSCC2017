...
In all four areas, we evaluate both the  system \textit{architecture}, which is more general, and the system \textit{implementation}, which was  used in our experiments.
%
\subsection{Autonomy}
%
