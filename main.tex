...
All designs are organized in a library of configurations and behaviors.
The library currently has 57 robot configurations and 97 behaviors.
The system can then use the design library to control the physical SMORES-EP robot to perform various actions.
