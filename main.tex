...
downward-facing webcam. This camera provide a view of a  $0.75m\times0.5m$ area
in front of the brain module, and is used to track AprilTa
...
At system level, the sensing components gather and process environment information for the high-level planner, which then makes decision based on the given robot tasks by invoking appropriate low-level controllers.
