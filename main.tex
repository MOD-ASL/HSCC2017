...
\newcommand{\Rboxheight}{-0.1\height}
\setlength{\tabcolsep}{5pt} %reduces horizontal padding in table. 
...
\hline
\raisebox{\Rboxheight}{ \includegraphics[width=\Lwidth, trim={0cm 0cm 0cm \Tbuffer}]{images/overhead_starting.jpg}} %\vspace{0.2cm}
...
\hline
\raisebox{\Rboxheight}{ \includegraphics[width=\Lwidth, trim={0cm 0cm 0cm \Tbuffer}]{images/stairs_explore_overhead.jpg}} %\vspace{0.2cm} 
& \pbox{\Rwidth}{Explore environment to find mailbox, then deliver a circuit to the box.}\\
\hline
\raisebox{\Rboxheight}{\includegraphics[width=\Lwidth, trim={0cm 0cm 0cm \Tbuffer}]{images/stamp_explore_overhead.jpg}} %\vspace{0.2cm}
