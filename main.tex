...
\hline
 & \\
\raisebox{-.5\height}{\includegraphics[width=0.25\textwidth]{images/overhead_starting.jpg}} & Explore environment to find all pink or green objects and the blue dropoff zone. Deliver all objects to dropoff zone.\\
 & \\
\hline
 & \\
