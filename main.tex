...
The success of our system is a product of the guiding principles used in its design.  Our centralized high-level framework represents a departure from the distributed frameworks typical of earlier MSRR systems, and has commonalities with frameworks employed successfully in some non-modular multi-robot systems \cite{Grabowski2000} {\color{red} cite more}.  This has implications for research both in modular self-reconfigurable systems and the larger field of multi-robot systems: first, researchers in MSRR might consider adopting a similar architecture in the design of their systems; and  second, researchers in multi-robot systems might consider utilizing elements of physical connection and self-reconfigurability as a strategy to address tasks. 

The following section presents the structure of our system, discusses the role of each component, and highlights key implementation details.  By providing a clear example of how a  system can be designed to leverage reactive reconfigurability in unknown environments, we have begun to blaze the path for reconfigurable systems to exit the lab, enter the real world, and make impact on our daily lives.
